    ...
    <!-- the title in the top  -->
        ...
        <form style="width: 600px; margin-left:16cm; margin-top:7%" method="post" enctype="multipart/form-data"
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                    <select class="shadow  bg-body rounded" aria-label="Default select example" name="ConditionServed"
                ...
                <div style="margin-top: 33px">
                    ...
                    <br>
                    <label style="clear: none"><input type="radio" name="SurveyType" value="PROM" checked> PROM</label>&nbsp;&nbsp;&nbsp;&nbsp;
                    <label style="clear: none"><input type="radio" name="SurveyType" value="PREM"> PREM</label>
                </div>
            </div>

                <div style="margin-left:3cm; margin-top:55px; width: 150Px">
