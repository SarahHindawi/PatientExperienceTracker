...
<div id="wrapper">
    ...
    <section class="container-fluid">
        ...
        <ul class="lp" style="margin-left: 220px">
            ...
            &nbsp;&nbsp;&nbsp;
            <li>
                <button class="block button button1" onclick="location.href='/passwordreset/create'" type="button">
                    <span><img src="{{asset('assets/images/request.png')}}" width="25" height="25"
                               class="d-inline-block align-right"> Patient Password Reset Requests<br> Click here to review</span>
                </button>
            </li>
            &nbsp;&nbsp;&nbsp;
            <li>
        ...
        -->
            <li>
                <button class="block button button1" onclick="location.href='/adminregistration'"><span><img
                            ...
                            class="d-inline-block align-right"> Register Admin
                </span></button>
            </li>
