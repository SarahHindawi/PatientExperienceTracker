...
<section class="container-fluid">
    ...
    <ul class="lp">
        ...
        &nbsp;&nbsp;&nbsp;
        <li><a href=""></a> <button class="block" onclick="location.href='/report/create'"> <img src="{{asset('assets/images/pen.png')}}" width="25" height="25" class="d-inline-block align-right"> Generate Report of PERM and PROM Survey Data</button></li>
        &nbsp;&nbsp;&nbsp;
